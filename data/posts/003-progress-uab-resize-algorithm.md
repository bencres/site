...
- The grid's row and column count must increase and decrease proportional to the dimensions of the grid's cell size.
- The grid's row and cloumn count still must respond to window resize events, maintaining cell size.
