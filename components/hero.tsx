    ...
    <section className="mb-20">
      <div className="mb-8">
        ...
        <p className="text-lg text-muted-foreground max-w-3xl leading-relaxed">
          <strong>Technical artist</strong> based in{" "}
          <span className="font-semibold">Dallas, Texas</span>.
        </p>
        <p className="text-lg text-muted-foreground max-w-3xl leading-relaxed mt-4">
          Currently a <strong>Pipeline Technical Director</strong> at Pixel Foundry, a <strong>Full-Stack Engineer</strong> for HytaleModding, and finishing my <strong>MFA in Game Development</strong>. 
        </p>
        <p className="text-lg text-muted-foreground max-w-3xl leading-relaxed mt-4">
